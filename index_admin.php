...
$beranda = array(
    $adder, $adder . 'index_admin.php', 
    $adder . 'index_admin.php?page=beranda'
);
...
$tambahUndangan_active = array(
    $adder . 'index_admin.php?page=tambahUndangan',
);
...
$tambahGambar_active = array(
    $adder . 'index_admin.php?page=tambahGambar',
);

$listGambar_active = array(
    $adder . 'index_admin.php?page=listGambar',
);

$user_active = array(
    $adder . 'index_admin.php?page=data_user',
    $adder . 'index_admin.php?page=ubah_user'
);

$register_active = array(
    $adder . 'index_admin.php?page=tambah_user',
);
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Baleekun Digital</div>
            </a>
